...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _index = __webpack_require__(/*! ./index */ \"./src/index.js\");\n\nvar _Card = __webpack_require__(/*! ./Card */ \"./src/Card.js\");\n\nvar _Card2 = _interopRequireDefault(_Card);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nvar CardList = function CardList(cards) {\n  var html = \"\\n    <ul>\\n      \" + cards.map(function (card) {\n    return (0, _Card2.default)(card);\n  }).join(\"\") + \"\\n    </ul>\\n  \";\n  (0, _index.render)(html, document.getElementById(\"root\"));\n};\n\nexports.default = CardList;\n\n//# sourceURL=webpack:///./src/CardList.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.render = undefined;\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _Form = __webpack_require__(/*! ./Form */ \"./src/Form.js\");\n\nvar _Form2 = _interopRequireDefault(_Form);\n\nvar _CardList = __webpack_require__(/*! ./CardList */ \"./src/CardList.js\");\n\nvar _CardList2 = _interopRequireDefault(_CardList);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar App = function () {\n  function App() {\n    _classCallCheck(this, App);\n\n    this.cards = [];\n    this.addCard = this.addCard.bind(this);\n  }\n\n  _createClass(App, [{\n    key: \"addCard\",\n    value: function addCard(data) {\n      this.cards = [data].concat(_toConsumableArray(this.cards));\n      (0, _CardList2.default)(this.cards);\n    }\n  }]);\n\n  return App;\n}();\n\nvar app = new App();\n\nvar form = new _Form2.default(app.addCard);\n\nvar render = exports.render = function render(html, node) {\n  return node.innerHTML = html;\n};\n\n//# sourceURL=webpack:///./src/index.js?");
